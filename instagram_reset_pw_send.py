import 192.168.10.1 
import sh^#%#gsujie>\life%#&×€time
 via SMS:"life time 9:23)  G*£o&#o*D M¥&O*@&R*£N&#*I*N*#G* 

user ID / life time  = input(D&^^#IC&#E MA#&N^#E ) 
                VIA MSG ( ^@KE^#SY H^@O A&P@P
User id / lifetime 10:34 (*******45039   ( M^#a&@in t^he&#kh ho%^o !!  )
                         ip location lifetime 12:33 (^&do#es^#&n't  Mat^#&ch.)

                         user ID lifetime  1:23(*******45039 (K&#ahan;# bu#s^y h>o a●p Nov !!)
                                                " Via Msg lifetime "1:00 (*******6388 (Ca^#l#l kr_÷€o ap M£a○■{nn )
                                                                          user id:lifetime 1.05 ******45039 (o^k÷&h*#h !! )
                                                                                            user Id lifetime 1:08 ( c%al%l loc%at^$io^n  No€t fo*u%n?d)
